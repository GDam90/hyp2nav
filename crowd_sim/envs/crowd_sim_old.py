...
class CrowdSim(gym.Env):
    ...
    def configure(self, config):
        ...
        self.case_size = {'train': config.env.train_size, 'val': config.env.val_size,
                          'test': config.env.test_size, 'test_viz': config.env.test_size}
    ...
    def reset(self, phase='test', test_case=None):
        ...
        :return:
        """
        assert phase in ['train', 'val', 'test', 'test_viz']
        self.phase = phase
        ...
        base_seed = {'train': self.case_capacity['val'] + self.case_capacity['test'] + train_seed_begin[1],
                     ...
                     'test_viz': self.case_capacity['val']+test_seed_begin[2]+1000}

        # def set(self, px, py, gx, gy, vx, vy, theta, radius=None, v_pref=None): \downarrow
