...
class CrowdSim(gym.Env):
    ...
    def render(self, mode='video', output_file=None, acts=None, not_best_actions=None, all_returns=None, action_indexes=None, max_action_indexes=None, radii=None):
        ...
        if mode == 'traj':
            ...
            ax.set_xlim(-self.panel_width/2, 13)#! self.panel_width/2)   #! /2
            ax.set_ylim(-self.panel_height/2, self.panel_height/2)
            ...
            for i in range(num_sectors):
                ...
                #     wedge = patches.Wedge((8.5,0), 4, 60 + (i * 3.75), (i + 1) * 3.75 + 60, edgecolor='black', facecolor=act_to_wedge_id[i][-1])
                # else:
                #     wedge = patches.Wedge((8.5,0), 4, 60 + (i * 3.75), (i + 1) * 3.75 + 60, edgecolor='black', facecolor='white')
                if i in act_to_wedge_id:
                    wedge = patches.Wedge((8.5,0), 4, (i * 22.5), (i + 1) * 22.5, edgecolor='black', facecolor=act_to_wedge_id[i][-1])
                else:
                    wedge = patches.Wedge((8.5,0), 4, (i * 22.5), (i + 1) * 22.5, edgecolor='black', facecolor='white')
    ...
    #                    ax.add_artist(self_attention_dis)
                ...
                if frame_num > 0:
                    ...
                    # for i in range(num_sectors):
                    #     # Plot a pie slice
                    #     # wedge = patches.Wedge((3,3), 2.4, -30 + (i * 3.75) + thetas[frame_num]*180/np.pi, -30 + (i + 1) * 3.75 + thetas[frame_num]*180/np.pi, edgecolor='black', facecolor='white')
                    #     wedges[i].set_theta1(-30 + (i * 3.75) + thetas[frame_num]*180/np.pi)
                    #     wedges[i].set_theta2(-30 + (i + 1) * 3.75 + thetas[frame_num]*180/np.pi)
                    #     # ax.add_artist(wedge)
